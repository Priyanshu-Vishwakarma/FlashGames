...
function initializeBoard() {
  ...
  document.getElementById("44").appendChild(createPiece("white"));
  document.getElementById("55").appendChild(createPiece("white"));
  document.getElementById("45").appendChild(createPiece("black"));
  document.getElementById("54").appendChild(createPiece("black"));
  whiteCount = 2;
  blackCount = 2;
  updateScores();
}
